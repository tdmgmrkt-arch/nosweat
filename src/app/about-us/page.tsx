...
import { aboutFaqs } from "@/data/about-faqs";
...
export default function AboutPage() {
  return (
    <div className="relative min-h-screen bg-[#090E1A] text-slate-300 selection:bg-brand-red/30 selection:text-white font-sans">
      ...
      <section className="relative z-10 overflow-hidden pt-20 pb-12 sm:pt-24 sm:pb-20 lg:pt-32">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 pt-12 sm:pt-16 lg:pt-24">
          <div className="max-w-3xl">
            {/* Luminous Breadcrumb */}
            <div className="mb-6 sm:mb-8 inline-flex items-center gap-2 rounded-full border border-white/5 bg-white/[0.03] px-3 sm:px-4 py-1.5 sm:py-2 text-[10px] sm:text-xs font-bold tracking-[0.1em] text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.1)] backdrop-blur-xl">
            ...
            <h1 className="font-heading text-3xl font-extrabold tracking-tight text-white drop-shadow-2xl sm:text-5xl md:text-6xl lg:text-7xl">
              About Us
            </h1>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="grid items-center gap-10 sm:gap-12 lg:gap-16 lg:grid-cols-2">
            ...
            <div className="relative">
              <div className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl sm:rounded-[2rem] bg-white/[0.02] p-1.5 sm:p-2 shadow-[inset_0_1px_0_rgba(255,255,255,0.1),_0_30px_60px_-15px_rgba(0,0,0,0.8)] ring-1 ring-white/10">
            ...
            <div className="lg:pl-8">
              ...
              <h2 className="mt-3 sm:mt-4 font-heading text-2xl sm:text-3xl font-extrabold text-white lg:text-4xl leading-tight">
                We have over 25 years experience in the HVAC industry
              </h2>
              <p className="mt-4 sm:mt-6 text-sm sm:text-base leading-relaxed text-slate-400 font-light">
              ...
              <p className="mt-3 sm:mt-4 text-sm sm:text-base leading-relaxed text-slate-400 font-light">
              ...
              <div className="mt-8 sm:mt-10 flex items-center gap-4 sm:gap-6 border-t border-white/10 pt-6 sm:pt-8">
                <div>
                  <p className="font-heading text-base sm:text-lg font-extrabold text-white">Justin Jaszewski</p>
      ...
      <section className="relative z-20 py-12 sm:py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="mb-8 sm:mb-12 flex flex-col items-center text-center">
            <h2 className="font-heading text-2xl sm:text-3xl font-extrabold tracking-tight text-white lg:text-4xl">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="grid items-center gap-10 sm:gap-12 lg:gap-16 lg:grid-cols-2">
            ...
            <div className="relative order-last lg:order-first">
              <div className="relative aspect-[5/4] w-full overflow-hidden rounded-2xl sm:rounded-[2rem] bg-white/[0.02] p-1.5 sm:p-2 shadow-[inset_0_1px_0_rgba(255,255,255,0.1),_0_30px_60px_-15px_rgba(0,0,0,0.8)] ring-1 ring-white/10">
                <div className="relative h-full w-full overflow-hidden rounded-xl sm:rounded-3xl">
                  <Image
                    src="/images/team-engaged.webp"
            ...
            <div className="lg:pr-8">
              ...
              <div className="mt-8 sm:mt-10 grid grid-cols-3 gap-3 sm:gap-4">
                {[
                  ...
                  <div key={stat.label} className="flex flex-col items-center justify-center rounded-xl sm:rounded-2xl bg-white/[0.02] p-3 sm:p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] ring-1 ring-white/10 backdrop-blur-sm transition-all hover:bg-white/[0.05] hover:-translate-y-1">
                    <p className="font-heading text-2xl sm:text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-b from-white to-slate-400 drop-shadow-sm">{stat.value}</p>
                    <p className="mt-1 sm:mt-2 text-[8px] sm:text-[9px] font-bold uppercase tracking-widest text-slate-500 text-center">{stat.label}</p>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section className="relative z-10 py-12 sm:py-16 lg:py-24">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="mb-8 sm:mb-12 text-center">
            ...
            <h2 className="mt-3 sm:mt-4 font-heading text-2xl sm:text-3xl font-extrabold text-white lg:text-4xl">
          ...
          <div className="grid grid-cols-2 gap-4 sm:gap-6 lg:grid-cols-4">
            {[
              ...
              <div key={item.label} className="group flex flex-col items-center rounded-2xl sm:rounded-3xl bg-[#0F172A]/50 p-5 sm:p-8 shadow-[inset_0_1px_0_rgba(255,255,255,0.05),_0_10px_30px_rgba(0,0,0,0.3)] ring-1 ring-white/5 backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:bg-[#151E32]/80 hover:ring-white/10">
                <p className={`font-heading text-3xl sm:text-5xl font-extrabold ${item.color} drop-shadow-[0_0_15px_currentColor] transition-transform group-hover:scale-110`}>
                  {item.stat}
                </p>
                <p className="mt-3 sm:mt-6 text-xs sm:text-sm font-medium leading-relaxed text-slate-300 text-center">{item.label}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid items-center gap-10 sm:gap-12 lg:gap-16 lg:grid-cols-2">
            <div>
              ...
              <div className="mt-8 sm:mt-10 space-y-4 sm:space-y-6">
                <div className="group flex items-start gap-4 sm:gap-5 rounded-xl sm:rounded-2xl bg-white/[0.01] p-4 sm:p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.02)] ring-1 ring-white/5 transition-all duration-300 hover:bg-white/[0.03] hover:ring-white/10">
                  <div className="flex h-10 w-10 sm:h-12 sm:w-12 shrink-0 items-center justify-center rounded-lg sm:rounded-xl bg-white/[0.03] shadow-[inset_0_1px_0_rgba(255,255,255,0.1)] ring-1 ring-white/10 transition-all duration-300 group-hover:bg-brand-blue/20 group-hover:ring-brand-blue/30">
                    <Zap className="h-4 w-4 sm:h-5 sm:w-5 text-slate-300 group-hover:text-brand-blue-light" />
                  </div>
                  <div>
                    <h3 className="font-heading text-base sm:text-lg font-extrabold text-slate-200 group-hover:text-white transition-colors">Fast, Reliable Service</h3>
                    <p className="mt-1.5 sm:mt-2 text-xs sm:text-sm text-slate-400 font-light leading-relaxed">
                ...
                <div className="group flex items-start gap-4 sm:gap-5 rounded-xl sm:rounded-2xl bg-white/[0.01] p-4 sm:p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.02)] ring-1 ring-white/5 transition-all duration-300 hover:bg-white/[0.03] hover:ring-white/10">
                  <div className="flex h-10 w-10 sm:h-12 sm:w-12 shrink-0 items-center justify-center rounded-lg sm:rounded-xl bg-white/[0.03] shadow-[inset_0_1px_0_rgba(255,255,255,0.1)] ring-1 ring-white/10 transition-all duration-300 group-hover:bg-brand-red/20 group-hover:ring-brand-red/30">
                    <ShieldCheck className="h-4 w-4 sm:h-5 sm:w-5 text-slate-300 group-hover:text-brand-red-light" />
                  </div>
                  <div>
                    <h3 className="font-heading text-base sm:text-lg font-extrabold text-slate-200 group-hover:text-white transition-colors">Emergency Services</h3>
                    <p className="mt-1.5 sm:mt-2 text-xs sm:text-sm text-slate-400 font-light leading-relaxed">
      ...
      <section className="relative z-10 py-12 sm:py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="mb-8 sm:mb-12 text-center">
            <h2 className="font-heading text-2xl sm:text-3xl font-extrabold text-white lg:text-4xl">
              Latest Insights
            </h2>
          </div>
            ...
            {blogPosts.slice(0, 3).map((post) => (
              ...
              >
                ...
                <div className="relative z-10 flex flex-1 flex-col p-5 pt-44 sm:p-8 sm:pt-57">
                  ...
                  <h3 className="mt-3 sm:mt-4 font-heading text-lg sm:text-xl font-extrabold text-white leading-snug tracking-wide group-hover:text-brand-blue-light transition-colors">
                    {post.title}
                  </h3>
                  ...
                  <div className="mt-6 sm:mt-8 flex items-center gap-2 text-sm font-bold text-slate-400 mt-auto transition-colors group-hover:text-white">
          ...
          <div className="mt-8 sm:mt-12 text-center">
            <Link href="/blog/" className="group inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-2xl bg-white/[0.03] px-8 py-4 text-sm font-bold text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.1)] ring-1 ring-white/10 transition-all duration-300 hover:bg-white/[0.08] hover:ring-white/20 hover:-translate-y-0.5 backdrop-blur-md">
      ...
      <section className="relative z-10 overflow-hidden py-16 sm:py-24 lg:py-32">
        ...
        <div className="relative mx-auto max-w-3xl px-4 sm:px-6 text-center">
          ...
          <div className="mt-8 sm:mt-12 flex flex-col items-center gap-4 sm:gap-5 sm:flex-row sm:justify-center">
            <Link href="/contact-us/" className="group inline-flex w-full sm:w-auto items-center justify-center gap-3 rounded-2xl bg-white px-8 py-4 text-sm sm:text-base font-extrabold text-[#090E1A] shadow-[0_0_20px_rgba(255,255,255,0.1)] transition-all duration-300 hover:bg-slate-200 hover:shadow-[0_0_30px_rgba(255,255,255,0.25)] hover:-translate-y-0.5">
              Get a Free Estimate <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
            </Link>
            <a href={companyInfo.phoneHref} className="group flex w-full sm:w-auto items-center justify-center gap-3 rounded-2xl bg-white/[0.03] px-8 py-4 text-sm sm:text-base font-extrabold text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.1)] ring-1 ring-white/20 transition-all duration-300 hover:bg-white/[0.08] hover:ring-white/30 hover:-translate-y-0.5">
