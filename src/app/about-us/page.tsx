    ...
    <>
      ...
      <section className="relative overflow-hidden bg-navy py-24 sm:py-28">
        <div className="absolute inset-0">
          <Image src="/images/team-engaged.webp" alt="The It's No Sweat Heat & Air team" fill priority className="object-cover" sizes="100vw" />
        ...
        <div className="relative mx-auto max-w-7xl px-6">
          <div className="max-w-3xl">
            ...
            <h1 className="font-heading text-4xl font-extrabold tracking-tight text-white drop-shadow-md sm:text-5xl lg:text-6xl">About Us</h1>
