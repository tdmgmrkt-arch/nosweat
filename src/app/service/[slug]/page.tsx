    ...
    <div className="relative min-h-screen bg-[#090E1A] text-slate-300 selection:bg-brand-red/30 selection:text-white font-sans">
      ...
      <section className="relative z-10 py-12 sm:py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="grid gap-8 sm:gap-10 lg:grid-cols-[280px_1fr] xl:grid-cols-[300px_1fr] lg:gap-16">
            ...
            <div className="min-w-0">
              ...
              {/* Feature Image Frame */}
              <div className="relative mb-8 sm:mb-12 aspect-[21/9] hidden sm:block w-full overflow-hidden rounded-2xl sm:rounded-[2rem] bg-white/[0.02] p-1.5 sm:p-2 shadow-[inset_0_1px_0_rgba(255,255,255,0.1),_0_30px_60px_-15px_rgba(0,0,0,0.8)] ring-1 ring-white/10">
              ...
              {/* INJECTED INLINE CTA */}
              <div className="relative my-10 sm:my-16 overflow-hidden rounded-2xl sm:rounded-[2rem] bg-gradient-to-br from-brand-blue/20 to-brand-blue/5 p-5 sm:p-8 md:p-10 shadow-[inset_0_1px_0_rgba(255,255,255,0.1),_0_20px_40px_rgba(0,0,0,0.5)] ring-1 ring-brand-blue/30 backdrop-blur-md">
                ...
                <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-6 sm:gap-8">
                  <div className="text-center sm:text-left">
                    <h3 className="font-heading text-xl sm:text-2xl font-extrabold text-white">Need {svc.shortTitle} Service?</h3>
                    <p className="mt-1.5 sm:mt-2 text-xs sm:text-sm font-medium text-brand-blue-light drop-shadow-[0_0_8px_rgba(59,130,246,0.3)]">Fast response. Upfront pricing. No surprises.</p>
                  </div>
                  <div className="flex shrink-0 flex-col gap-3 sm:gap-4 w-full sm:w-auto">
              ...
              {/* Check Subsection */}
              <div className="mt-10 sm:mt-16 grid items-center gap-8 sm:gap-10 sm:grid-cols-2">
                <div className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl sm:rounded-[2rem] bg-white/[0.02] p-1.5 sm:p-2 shadow-[inset_0_1px_0_rgba(255,255,255,0.1),_0_20px_40px_-10px_rgba(0,0,0,0.5)] ring-1 ring-white/10">
                ...
                <div>
                  <h3 className="font-heading text-xl sm:text-2xl font-extrabold text-white tracking-tight">{svc.checkTitle}</h3>
                  <p className="mt-3 sm:mt-4 text-sm sm:text-base leading-relaxed text-slate-400 font-light">{svc.checkContent}</p>
                  <ul className="mt-4 sm:mt-6 space-y-3 sm:space-y-4">
                    {svc.checkBullets.map((b) => (
                      <li key={b} className="flex items-start gap-2.5 sm:gap-3 text-xs sm:text-sm font-medium text-slate-300">
              ...
              {/* Trust Badges */}
              <div className="mt-12 sm:mt-20 grid grid-cols-3 gap-3 sm:gap-6">
                {[
                  ...
                  <div key={badge.title} className="group flex flex-col items-center justify-center rounded-xl sm:rounded-[2rem] bg-white/[0.02] px-3 py-6 sm:px-6 sm:py-10 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] ring-1 ring-white/10 transition-all duration-300 hover:-translate-y-1 hover:bg-white/[0.04]">
                    <div className={`mb-3 sm:mb-5 flex h-12 w-12 sm:h-16 sm:w-16 items-center justify-center rounded-xl sm:rounded-2xl ${badge.bg} ${badge.ring} shadow-[inset_0_1px_0_rgba(255,255,255,0.1)] transition-transform duration-300 group-hover:scale-110`}>
                      <badge.icon className={`h-6 w-6 sm:h-8 sm:w-8 ${badge.color} drop-shadow-[0_0_8px_currentColor]`} />
                    </div>
                    <p className="text-center text-xs sm:text-sm font-extrabold tracking-wide text-white">{badge.title}</p>
                  </div>
                ))}
              </div>

              {/* Benefits */}
              <div className="mt-12 sm:mt-20 rounded-2xl sm:rounded-[2rem] bg-[#0F172A]/50 p-5 sm:p-8 md:p-10 shadow-[inset_0_1px_0_rgba(255,255,255,0.05),_0_20px_40px_rgba(0,0,0,0.3)] ring-1 ring-white/5 backdrop-blur-md">
                <h3 className="font-heading text-xl sm:text-2xl font-extrabold text-white text-center sm:text-left tracking-tight">Benefits of Service</h3>
                <div className="mx-auto mt-3 sm:mt-4 h-1 w-12 rounded-full bg-gradient-to-r from-brand-red to-red-500 sm:mx-0 shadow-[0_0_10px_rgba(220,38,38,0.5)]" />
                <div className="mt-6 sm:mt-10 grid gap-3 sm:gap-4 sm:grid-cols-2">
                  {svc.benefits.map((b) => (
                    <div key={b} className="flex items-start gap-3 sm:gap-4 rounded-lg sm:rounded-xl bg-white/[0.02] p-3.5 sm:p-5 ring-1 ring-white/10 transition-colors hover:bg-white/[0.04]">
                      <CheckCircle2 className="mt-0.5 h-4 w-4 sm:h-5 sm:w-5 shrink-0 text-brand-red drop-shadow-[0_0_8px_rgba(220,38,38,0.6)]" />
                      <span className="text-xs sm:text-sm font-medium text-slate-300">{b}</span>
                    </div>
                  ))}
                </div>
              </div>
