    ...
    <div className="relative min-h-screen bg-[#090E1A] text-slate-300 selection:bg-brand-red/30 selection:text-white font-sans">
      ...
      <section className="relative z-10 py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-6">
          <div className="rounded-[2rem] bg-[#0F172A]/50 p-8 sm:p-12 shadow-[inset_0_1px_0_rgba(255,255,255,0.05),_0_20px_40px_rgba(0,0,0,0.3)] ring-1 ring-white/5 backdrop-blur-md">

            {/* Who We Are */}
            <div className="mb-12">
              <div className="flex items-center gap-3 mb-4">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-brand-blue/10 ring-1 ring-brand-blue/30">
            ...
            {/* SMS Terms */}
            <div className="mb-12">
              <h2 className="font-heading text-2xl font-extrabold text-white mb-4">SMS Terms &amp; Privacy</h2>
              <p className="text-base leading-relaxed text-slate-400">
            ...
            <div className="space-y-10">
              {[
                ...
                <div key={section.title} className="group">
                  <h3 className="flex items-center gap-3 font-heading text-lg font-extrabold text-white mb-3">
                    <span className="flex h-7 w-7 items-center justify-center rounded-lg bg-white/5 text-xs font-bold text-slate-500 ring-1 ring-white/10">{i + 1}</span>
                    {section.title}
                  </h3>
            ...
            <div className="rounded-2xl bg-white/[0.02] p-6 ring-1 ring-white/10">
              <h3 className="font-heading text-lg font-extrabold text-white mb-4">Help &amp; Support</h3>
              <p className="text-sm leading-relaxed text-slate-400 mb-4">
                Contact {companyInfo.name} for help or to stop receiving messages:
              </p>
              <div className="flex flex-wrap gap-4">
                <a href={companyInfo.phoneHref} className="inline-flex items-center gap-2 rounded-xl bg-white/5 px-4 py-2.5 text-sm font-bold text-white ring-1 ring-white/10 transition-all hover:bg-brand-blue/20 hover:ring-brand-blue/30">
                  <Phone className="h-4 w-4 text-brand-blue-light" /> {companyInfo.phone}
                </a>
                <a href={companyInfo.emailHref} className="inline-flex items-center gap-2 rounded-xl bg-white/5 px-4 py-2.5 text-sm font-bold text-white ring-1 ring-white/10 transition-all hover:bg-brand-blue/20 hover:ring-brand-blue/30">
