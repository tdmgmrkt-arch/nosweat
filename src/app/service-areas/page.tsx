    ...
    <div className="relative min-h-screen bg-[#090E1A] text-slate-300 selection:bg-brand-red/30 selection:text-white font-sans">
      ...
      <section className="relative z-10 overflow-hidden pt-24 pb-20 sm:pt-32">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 pt-16 sm:pt-24">
          ...
          <h1 className="font-heading text-5xl font-extrabold tracking-tight text-white sm:text-6xl lg:text-7xl max-w-4xl drop-shadow-2xl">
          ...
          <p className="mt-8 max-w-2xl text-xl text-slate-300 font-light leading-relaxed drop-shadow-md">
      ...
      <section className="relative z-10 py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-12">
            ...
            <p className="mt-4 max-w-2xl text-base text-slate-400 font-light leading-relaxed">
          ...
          <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            {serviceAreaCities.map((area) => (
              <Link
                key={area.city}
                href={area.url}
                className="group flex items-center gap-4 rounded-2xl bg-white/[0.02] px-6 py-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] ring-1 ring-white/10 backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:bg-white/[0.04] hover:ring-brand-blue/30 hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.1),_0_10px_20px_rgba(0,0,0,0.3)]"
              >
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-white/[0.03] ring-1 ring-white/10 transition-colors group-hover:bg-brand-blue/20 group-hover:ring-brand-blue/30">
                  <MapPin className="h-4 w-4 text-slate-500 transition-colors group-hover:text-brand-blue-light" />
                </div>
                <span className="text-base font-bold text-slate-300 transition-colors group-hover:text-white">
                  {area.city}
                </span>
                <ArrowRight className="ml-auto h-4 w-4 text-white/10 transition-all duration-300 group-hover:translate-x-1 group-hover:text-brand-blue-light" />
              </Link>
            ))}
          </div>
        </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {serviceHighlights.map((svc) => (
              <Link
                key={svc.title}
                href={svc.href}
                className="group flex flex-col rounded-[2rem] bg-[#0F172A]/50 p-8 shadow-[inset_0_1px_0_rgba(255,255,255,0.05),_0_10px_30px_rgba(0,0,0,0.3)] ring-1 ring-white/5 backdrop-blur-md transition-all duration-300 hover:-translate-y-1.5 hover:bg-[#151E32]/80 hover:ring-white/20 hover:shadow-[0_20px_40px_rgba(0,0,0,0.5)]"
              >
                <div className="mb-6 flex items-center gap-4">
                  <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-brand-blue/10 text-brand-blue ring-1 ring-brand-blue/30 shadow-[inset_0_1px_0_rgba(255,255,255,0.1)] transition-all duration-300 group-hover:scale-110 group-hover:shadow-[0_0_15px_rgba(59,130,246,0.5)]">
                    <svc.icon className="h-6 w-6" />
                  </div>
                  <h3 className="font-heading text-xl font-extrabold text-white transition-colors group-hover:text-brand-blue-light">{svc.title}</h3>
                </div>
                <p className="text-[15px] font-light leading-relaxed text-slate-400 flex-1">{svc.description}</p>
                <span className="mt-8 inline-flex items-center gap-2 text-sm font-bold text-slate-500 transition-colors group-hover:text-white">
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid items-center gap-16 lg:grid-cols-2">
            ...
            <div>
              ...
              <div className="mt-8 space-y-6 text-base font-light leading-relaxed text-slate-400">
                <p>
      ...
      <section className="relative z-10 overflow-hidden py-32">
        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center">
          ...
          <div className="mt-12 flex flex-col items-center gap-5 sm:flex-row sm:justify-center">
            <Link href="/contact-us/" className="group inline-flex w-full sm:w-auto items-center justify-center gap-3 rounded-xl bg-white px-8 py-4 text-base font-extrabold text-[#090E1A] shadow-[0_0_20px_rgba(255,255,255,0.1)] transition-all duration-300 hover:bg-slate-200 hover:shadow-[0_0_30px_rgba(255,255,255,0.25)] hover:-translate-y-0.5">
              <CalendarCheck className="h-5 w-5" /> Request Service Online <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
            </Link>
            <a href={companyInfo.phoneHref} className="group flex w-full sm:w-auto items-center justify-center gap-3 rounded-xl bg-gradient-to-b from-red-500 to-brand-red px-8 py-4 text-base font-extrabold text-white shadow-[inset_0_1px_1px_rgba(255,255,255,0.3),_0_8px_20px_-6px_rgba(220,38,38,0.6)] ring-1 ring-brand-red/50 transition-all hover:shadow-[inset_0_1px_1px_rgba(255,255,255,0.4),_0_12px_25px_-6px_rgba(220,38,38,0.8)] hover:-translate-y-0.5">
