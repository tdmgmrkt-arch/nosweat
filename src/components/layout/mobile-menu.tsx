          ...
          {isOpen && (
            <>
              ...
              <motion.div
                ...
                className="fixed inset-0 z-[60] bg-[#090E1A]/80 backdrop-blur-md"
                onClick={close}
              />
              ...
              <motion.div
                ...
                className="fixed inset-y-0 right-0 z-[70] flex w-[85vw] max-w-sm flex-col border-l border-white/10 bg-[#0F172A]/95 shadow-[-20px_0_40px_rgba(0,0,0,0.5)] backdrop-blur-2xl"
              >
                {/* Close bar */}
